# 🏗️ SOLID Principles in RecruitCRM
...
- `RecruitmentModule` coordinates the recruitment process but does not perform individual tasks itself. 🎛️
...
## ⬆️⬇️ Dependency Inversion Principle (DIP)
